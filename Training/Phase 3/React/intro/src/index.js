...
function MyRouter() {
  return (
    <div className="container-fluid" style={body1}>
      <nav className="navbar navbar-expand-md navbar-light pt-5 pb-4">
        <div className="container-xxl">
          <a className="navbar-brand" href="#intro">
            <span className="text-secondary fw-bold">Geo Info Tech</span>
          </a>
      ...
      <Router>
        <h1 className="text-center text-danger ">CRM SYSTEM</h1>
...
// import SclassName from './aa pair studentdatasav'
