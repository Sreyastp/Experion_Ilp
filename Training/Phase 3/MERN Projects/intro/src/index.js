...
import DeleteStaff from "./staffedit";
    ...
    <div className="container-fluid" style={body1}>
      ...
      <Router>
        ...
        <div>
          ...
          <Link className="btn btn-primary mb-2 ms-2" to="/staffedit">
            StaffEdit
          </Link>
          <Link className="btn btn-primary mb-2 ms-2" to="/DeleteStaff">
            Staff delete
          </Link>
          <Link className="btn btn-primary mb-2 ms-2" to="/reduxdemo">
            ReduxDemo
          </Link>
        </div>
        <hr />
